...
public class GrabberCommandCone extends CommandBase {
  ...
  public GrabberCommandCone(GrabberSubsystemCone grabberCone, double grabberSpeedCone) {
    ...
    this.grabberSpeedCone = grabberSpeedCone;
  }
  ...
  @Override
  public void execute() {
    grabberCone.grabberConeOn(grabberSpeedCone);
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    grabberCone.grabberConeOff();
  }
